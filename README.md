...
- **City mode**: deterministic waterfront cities with seed-generated coastlines and connected street networks, blocks, parcels, civic core, parks, hill contours, and a `1×–5×` district-scale control for exploring larger populated regions

...
- **City mode**: deterministic waterfront cities with seed-generated coastlines and connected street networks, blocks, parcels, randomized civic buildings or tree-filled civic parks, multiple functional parks with internal paths and amenities, hill contours, a `1×–5×` district-scale control with scale-aware zoom-out, and city building-count toggles up to `384` buildings
- **Atmosphere**: seed-randomized clouds and a small city bird flock placed in world space with camera-facing and viewport culling
